...
class BookRoomSuperMoon extends React.Component {
    constructor (props) {
        super(props)
                            ...
                            <Col md="8" className="mt-3 mx-auto">
                                <Jumbotron>
                                    ...
                                    <select name="room" id="room" type="text">
                                        <option value="Blue Hour" disabled selected >Super Moon</option>
                                    </select><br/>
                                    <br/><br/>
                                    <div class="row">
                                        <div class="col-sm-4">
...
export default BookRoomSuperMoon;